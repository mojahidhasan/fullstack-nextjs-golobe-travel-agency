...
import flightDB from "@/data/flight";
...
export async function c(formData) {
  console.log(formData);
  const data = Object.fromEntries(formData);
  delete data["$ACTION_ID_663e4637eda9b02311b291eb479d20de9386a683"];
  console.log(data);
  flightDB.insert(data, (err, data) => {
    if (err) {
      console.log(err);
    }
    console.log(data);
