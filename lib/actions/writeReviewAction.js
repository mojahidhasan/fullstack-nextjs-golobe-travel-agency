...
export default async function writeReviewAction(
  ...
  if (flightOrHotel === "hotels") {
    reviewObj.hotelId = reviewKeys.hotelId;
  ...
  try {
    if (isAlreadyReviewed) {
      ...
      await createOneDoc(dbModel, { ...reviewObj, flaged: [] });
    }
